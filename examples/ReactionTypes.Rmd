...
```{r}
  ...
  source("../Rstringmol/R/rconf_params.R")
...
ok, that worked! So let's try it for a whole run...write it to a pdf

```{r}

#pdf(file = "D:/sjh/stringmol/smsp5types.pdf",width = 10,height = 10)

tstep <- 100000 #sometimes its 10000
tt <- 1500000 + tstep
sps <- list()
nsps <- 1
gotdata<-T
