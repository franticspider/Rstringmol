...
```{r load_data, fig.height=6, fig.width=10, include=FALSE, cache = T}
...
```{r popdy, fig.height=6, fig.width=10, message = F, warning=FALSE, cache = T}
...
```{r fig1a, fig.height=6, fig.width=10, cache = T}
...
```{r  fig.height=6, fig.width=10, message = F, warning=FALSE, cache = T}
...
```{r fig.height=2.5, fig.width=10,echo=F,eval=T, cache = T}
