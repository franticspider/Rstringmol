...
if(A == B)
  switch(prodA.k)
    case -: return "No Product"
    case A: return "Replicator"
    case 0: return "No Product"
    case X: return "Different Product"
    case Y: reutrn "Macromutation"
else  
  rtype = "No Product"
  switch(prodA.k)
    case -: rtype =  "No Product"
    case A: rtype =  "Replicator"
    case 0: rtype =  "No Product"
    case X: rtype =  "Different Product"
    case B: rtype =  "Parasite"
    case Y: rtype =  "Macromutation"
  if(!prodA.deterministicBind)
    prodB = react(B,A)
    if(prodB.k == B)
      if(prodB.k == A)
        rtype = "Replicator"
