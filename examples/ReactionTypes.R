...
froot="~/Desktop/paulien/smsp/1705sm250/out4"
...
#  dev.off()
  ...
  if(file.exists(fn)){
    ...
    plot(NA,xlim=c(0,ps$gridx),ylim=c(0,ps$gridy),asp=1,main=sprintf("Reactions at T= %d",tt))
    ...
    par(oldpar) 
    plot(NA,xlim=c(0,ps$gridx),ylim=c(0,ps$gridy),asp=1,main=sprintf("Length at T= %d",tt))
    #rect(xleft = 0,xright=ps$gridx,ybottom = 0,ytop=ps$gridy,col="black",lty = "blank")
    ...
    par(oldpar) 
    plot(NA,xlim=c(0,ps$gridx),ylim=c(0,ps$gridy),asp=1,main=sprintf("Species at T= %d",tt))
    #rect(xleft = 0,xright=ps$gridx,ybottom = 0,ytop=ps$gridy,col="black",lty = "blank")
