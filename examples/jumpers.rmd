...
get_pos_plot <- function(cf,t,box=NA){
  ...
  rect(xleft=aa$V5-1,xright=aa$V5,ybottom=125-aa$V4,ytop=125-aa$V4+1,col="red",border="blue",lwd=0)
...
```{r}
  cf <- read.table(sprintf("%sout1_%d.conf",froot,1540000),as.is = T, fill = T, sep=" ",comment.char="",stringsAsFactors = F)
hits <- get_pos_plot(cf,1540000,c(50,75,50,60))
```
