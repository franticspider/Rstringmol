...
- The flood ends when.... even longer replicators emerge
...
- **t6:** at the very end of the run we see new patches of longer molecules - I'll look into what these are, and try to understand their dynamics. 
...
At this point, the flood recedes. Why? It's worth studying the last 15 seconds of the 'species' movie at the top of this document, which appears to show a classic parasitic invasion. Indeed 857/3688 reactions are now parasitic. So let's first look at the most common parasitic reaction. 

Here, the molecule  `$=?>^AC` is active, and  `$=?D}ICAT>V^BC>$UP%}UY` is passive. This looks suspicious straghtaway! Here's the reaction pathway: 


```{r floodt6p,engine='tikz',fig.width=10, message=F, echo=F}
\begin{tikzpicture}[font=\sffamily\tiny]
